...
class GoogleDriveService
  ...
  def upload_file(file_path, file_name, mime_type)
    file_metadata = Google::Apis::DriveV3::File.new(name: file_name, parents: ['1Sil__USbq7I4jhsW2tVhgZ1tlc8iLSRm'])

    # parents: ['1Sil__USbq7I4jhsW2tVhgZ1tlc8iLSRm'] is the folder id
